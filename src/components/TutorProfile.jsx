export default function TutorProfile({tutor, tutorImg}) {
    return (
        <div className = "w-full flex items-center justify-center dark:text-white">
            <div className = "flex flex-col  w-8/10 md:w-5/9 py-2 my-2 px-2 justify-center items-center hover:shadow-md  rounded-3xl hover:bg-light-orange-1/20 transition-shadow">
